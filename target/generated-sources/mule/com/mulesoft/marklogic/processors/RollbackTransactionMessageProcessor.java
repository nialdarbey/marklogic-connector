...
/**
 * RollbackTransactionMessageProcessor invokes the {@link com.mulesoft.marklogic.MarkLogic#rollbackTransaction()} method in {@link MarkLogic }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.3.1", date = "2012-09-19T03:49:43-03:00", comments = "Build UNNAMED.1297.150f2c9")
public class RollbackTransactionMessageProcessor
        ...
        try {
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((MarkLogic) object).rollbackTransaction();
                    return null;
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("rollbackTransaction"), event, e);
        }
    }
