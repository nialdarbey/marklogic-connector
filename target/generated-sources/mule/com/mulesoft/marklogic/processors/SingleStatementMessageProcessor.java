...
/**
 * SingleStatementMessageProcessor invokes the {@link com.mulesoft.marklogic.MarkLogic#singleStatement(java.lang.String)} method in {@link MarkLogic }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.3.1", date = "2012-09-19T03:49:43-03:00", comments = "Build UNNAMED.1297.150f2c9")
public class SingleStatementMessageProcessor
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        try {
            ...
            final String _transformedAdhocQuery = ((String) evaluateAndTransform(getMuleContext(), event, SingleStatementMessageProcessor.class.getDeclaredField("_adhocQueryType").getGenericType(), null, adhocQuery));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((MarkLogic) object).singleStatement(_transformedAdhocQuery);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("singleStatement"), event, e);
        }
    }
